...
";
    ...
    public static void Generate()
    {
...
#if UNITY_EDITOR
        content = File.ReadAllText($"{Application.dataPath}\\GameData\\GameText.json");
#else
        ...
        File.WriteAllText($"{Application.dataPath}\\GameData\\UIText.cs", string.Format(scriptTemplate, strings));
    }
}
